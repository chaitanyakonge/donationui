  ...
  return (
    <div className="min-h-screen bg-orange-50">
            ...
            <div className="flex-shrink-0 flex items-center px-4">
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  ...
                  <p className="text-sm text-gray-500">Charitable Trust</p>
                </div>
              </div>
            </div>
          ...
          <div className="flex-shrink-0 flex border-t border-gray-200 p-4">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                ...
                <p className="text-xs text-gray-500">admin@Kimayaashram.org</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="md:pl-64 flex flex-col flex-1">
        {/* Top bar */}
        <div className="sticky top-0 z-10 md:hidden pl-1 pt-1 sm:pl-3 sm:pt-3 bg-orange-50">
          <button
            type="button"
        ...
        {/* Page header */}
        <div className="bg-amber-800 shadow-sm border-b border-amber-900">
